...
```php
enclosureGet($limit, $offset, $count, $sort)
```
...
$apiInstance = new RMoore\Truenas\Api\EnclosureApi(
...
try {
    $apiInstance->enclosureIdIdGet($id);
} catch (Exception $e) {
...
try {
    $apiInstance->enclosureIdIdPut($id);
} catch (Exception $e) {
...
```php
enclosureSetSlotStatusPost($enclosure_set_slot_status)
```
...
$enclosure_set_slot_status = new \RMoore\Truenas\Model\EnclosureSetSlotStatus(); // \RMoore\Truenas\Model\EnclosureSetSlotStatus

try {
    $apiInstance->enclosureSetSlotStatusPost($enclosure_set_slot_status);
} catch (Exception $e) {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **enclosure_set_slot_status** | [**\RMoore\Truenas\Model\EnclosureSetSlotStatus**](../Model/EnclosureSetSlotStatus.md)|  | [optional]
