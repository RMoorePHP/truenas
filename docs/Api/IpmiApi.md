...
$apiInstance = new RMoore\Truenas\Api\IpmiApi(
...
try {
    $apiInstance->ipmiClearSelGet();
} catch (Exception $e) {
    echo 'Exception when calling IpmiApi->ipmiClearSelGet: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
ipmiGet($limit, $offset, $count, $sort)
```
...
```php
ipmiIdentifyPost($ipmi_identify0)
```
...
$ipmi_identify0 = new \RMoore\Truenas\Model\IpmiIdentify0(); // \RMoore\Truenas\Model\IpmiIdentify0

try {
    $apiInstance->ipmiIdentifyPost($ipmi_identify0);
} catch (Exception $e) {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **ipmi_identify0** | [**\RMoore\Truenas\Model\IpmiIdentify0**](../Model/IpmiIdentify0.md)|  | [optional]
...
```php
ipmiQuerySelGet($limit, $offset, $count, $sort)
```
...
try {
    $apiInstance->ipmiQuerySelGet($limit, $offset, $count, $sort);
} catch (Exception $e) {
    echo 'Exception when calling IpmiApi->ipmiQuerySelGet: ', $e->getMessage(), PHP_EOL;
}
```
