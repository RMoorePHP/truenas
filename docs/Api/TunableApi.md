...
```php
tunableGet($limit, $offset, $count, $sort)
```
...
$apiInstance = new RMoore\Truenas\Api\TunableApi(
...
$tunable_create0 = new \RMoore\Truenas\Model\TunableCreate0(); // \RMoore\Truenas\Model\TunableCreate0

try {
    $apiInstance->tunablePost($tunable_create0);
} catch (Exception $e) {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **tunable_create0** | [**\RMoore\Truenas\Model\TunableCreate0**](../Model/TunableCreate0.md)|  | [optional]
