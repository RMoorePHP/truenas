 ...
 */
class MailUpdate0 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'mail_update_0';
    ...
    */
     ...
     * Sets fromemail
     *
     * @param string|null $fromemail `fromemail` is used as a sending address which the mail server will use for sending emails.
     *
     * @return self
     */
     ...
     * Sets outgoingserver
     *
     * @param string|null $outgoingserver `outgoingserver` is the hostname or IP address of SMTP server used for sending an email.
     *
     * @return self
     */
     ...
     * Sets security
     *
     * @param string|null $security `security` is type of encryption desired.
     *
     * @return self
     */
