...
/**
 * ZfsSnapshotCreate0 Class Doc Comment
 *
 * @category Class
 * @package  RMoore\Truenas
 * @author   OpenAPI Generator team
 ...
 */
class ZfsSnapshotCreate0 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'zfs_snapshot_create_0';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('vmware_sync', $data ?? [], false);
    ...
    */
     ...
     * @return bool|null
     */
    public function getVmwareSync()
    {
        return $this->container['vmware_sync'];
    }

    /**
     * Sets vmware_sync
     *
     * @param bool|null $vmware_sync vmware_sync
     *
     * @return self
     */
    public function setVmwareSync($vmware_sync)
    {

        if (is_null($vmware_sync)) {
            throw new \InvalidArgumentException('non-nullable vmware_sync cannot be null');
        }

        $this->container['vmware_sync'] = $vmware_sync;
