...
/**
 * SharingWebdavCreate0 Class Doc Comment
 *
 * @category Class
 * @package  RMoore\Truenas
 * @author   OpenAPI Generator team
 ...
 */
class SharingWebdavCreate0 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'sharing_webdav_create_0';
    ...
    {
        $this->setIfExists('perm', $data ?? [], true);
    ...
    */
     ...
     * Sets ro
     *
     * @param bool|null $ro `ro` when enabled prohibits users from writing to this share.
     *
     * @return self
     */
