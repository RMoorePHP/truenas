...
/**
 * ReplicationCreateDataset Class Doc Comment
 *
 * @category Class
 * @package  RMoore\Truenas
 * @author   OpenAPI Generator team
 ...
 */
class ReplicationCreateDataset implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'replication_create_dataset';
    ...
    protected static $openAPITypes = [
        'dataset' => 'string',
        'transport' => '\RMoore\Truenas\Model\ReplicationCreateDataset1',
        'ssh_credentials' => 'int'
    ];
    ...
    */
     ...
     * Sets dataset
     *
     * @param string|null $dataset Accepts `dataset` name, `transport` and SSH credentials ID (for non-local transport)
     *
     * @return self
     */
     ...
     * Gets transport
     *
     * @return \RMoore\Truenas\Model\ReplicationCreateDataset1|null
     */
     ...
     * Sets transport
     *
     * @param \RMoore\Truenas\Model\ReplicationCreateDataset1|null $transport transport
     *
     * @return self
     */
