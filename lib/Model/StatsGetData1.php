...
/**
 * StatsGetData1 Class Doc Comment
 *
 * @category Class
 * @package  RMoore\Truenas
 * @author   OpenAPI Generator team
 ...
 */
class StatsGetData1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'stats_get_data_1';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('start', $data ?? [], 'now-1h');
        $this->setIfExists('end', $data ?? [], 'now');
    }
