 ...
 */
class KeyUsage1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'KeyUsage_1';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('key_cert_sign', $data ?? [], true);
        $this->setIfExists('crl_sign', $data ?? [], true);
