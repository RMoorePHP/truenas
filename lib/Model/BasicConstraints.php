...
/**
 * BasicConstraints Class Doc Comment
 *
 * @category Class
 * @package  RMoore\Truenas
 * @author   OpenAPI Generator team
 ...
 */
class BasicConstraints implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BasicConstraints';
    ...
    {
        $this->setIfExists('ca', $data ?? [], false);
