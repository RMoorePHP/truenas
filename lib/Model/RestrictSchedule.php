...
/**
 * RestrictSchedule Class Doc Comment
 *
 * @category Class
 ...
 */
class RestrictSchedule implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'restrict_schedule';
    ...
    {
        $this->setIfExists('minute', $data ?? [], '00');
        $this->setIfExists('hour', $data ?? [], '*');
        $this->setIfExists('dom', $data ?? [], '*');
        $this->setIfExists('month', $data ?? [], '*');
        $this->setIfExists('dow', $data ?? [], '*');
        $this->setIfExists('begin', $data ?? [], '00:00');
        $this->setIfExists('end', $data ?? [], '23:59');
    }
