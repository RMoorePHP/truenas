...
/**
 * AuthorityKeyIdentifier Class Doc Comment
 *
 * @category Class
 * @package  RMoore\Truenas
 * @author   OpenAPI Generator team
 ...
 */
class AuthorityKeyIdentifier implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AuthorityKeyIdentifier';
    ...
    protected static $setters = [
        'authority_cert_issuer' => 'setAuthorityCertIssuer',
        'enabled' => 'setEnabled',
    ...
    protected static $getters = [
        'authority_cert_issuer' => 'getAuthorityCertIssuer',
        'enabled' => 'getEnabled',
    ...
    {
        $this->setIfExists('authority_cert_issuer', $data ?? [], false);
    ...
    */
    ...
    /**
     * Gets authority_cert_issuer
     *
     * @return bool|null
     */
    public function getAuthorityCertIssuer()
    {
        return $this->container['authority_cert_issuer'];
    }

    /**
     * Sets authority_cert_issuer
     *
     * @param bool|null $authority_cert_issuer authority_cert_issuer
     *
     * @return self
     */
    public function setAuthorityCertIssuer($authority_cert_issuer)
    {

        if (is_null($authority_cert_issuer)) {
            throw new \InvalidArgumentException('non-nullable authority_cert_issuer cannot be null');
        }

        $this->container['authority_cert_issuer'] = $authority_cert_issuer;
