...
/**
 * ReplicationRunOnetime0 Class Doc Comment
 *
 * @category Class
 * @package  RMoore\Truenas
 * @author   OpenAPI Generator team
 ...
 */
class ReplicationRunOnetime0 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'replication_run_onetime_0';
    ...
    protected static $openAPITypes = [
        ...
        'name_regex' => 'string',
        'restrict_schedule' => '\RMoore\Truenas\Model\RestrictSchedule1',
    ...
    protected static $openAPIFormats = [
        ...
        'retries' => null,
        'logging_level' => null,
        'exclude_mountpoint_property' => null,
        'only_from_scratch' => null
    ];
    ...
    protected static $attributeMap = [
        ...
        'only_from_scratch' => 'only_from_scratch'
    ];
    ...
    protected static $setters = [
        ...
        'exclude_mountpoint_property' => 'setExcludeMountpointProperty',
        'only_from_scratch' => 'setOnlyFromScratch'
    ];
    ...
    protected static $getters = [
        ...
        'exclude_mountpoint_property' => 'getExcludeMountpointProperty',
        'only_from_scratch' => 'getOnlyFromScratch'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('exclude_mountpoint_property', $data ?? [], true);
        $this->setIfExists('only_from_scratch', $data ?? [], false);
    }
    ...
    */
     ...
     *
     * @param string|null $netcat_active_side netcat_active_side
     *
     * @return self
     */
     ...
     *
     * @param int|null $netcat_active_side_port_min netcat_active_side_port_min
     *
     * @return self
     */
     ...
     *
     * @param int|null $netcat_active_side_port_max netcat_active_side_port_max
     *
     * @return self
     */
     ...
     * Sets properties
     *
     * @param bool|null $properties properties
     *
     * @return self
     */
     ...
     *
     * @param int[]|null $periodic_snapshot_tasks periodic_snapshot_tasks
     *
     * @return self
     */
     ...
     * Sets naming_schema
     *
     * @param string[]|null $naming_schema naming_schema
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $also_include_naming_schema also_include_naming_schema
     *
     * @return self
     */
     ...
     *
     * @return \RMoore\Truenas\Model\RestrictSchedule1|null
     */
     ...
     *
     * @param \RMoore\Truenas\Model\RestrictSchedule1|null $restrict_schedule restrict_schedule
     *
     * @return self
     */
     ...
     *
     * @param bool|null $allow_from_scratch allow_from_scratch
     *
     * @return self
     */
     ...
     * Sets readonly
     *
     * @param string|null $readonly readonly
     *
     * @return self
     */
     ...
     *
     * @param bool|null $hold_pending_snapshots hold_pending_snapshots
     *
     * @return self
     */
     ...
     *
     * @param string|null $retention_policy retention_policy
     *
     * @return self
     */
     ...
     * Sets speed_limit
     *
     * @param int|null $speed_limit speed_limit
     *
     * @return self
     */
     ...
     * Sets large_block
     *
     * @param bool|null $large_block large_block
     *
     * @return self
     */
    ...
    /**
     * Gets exclude_mountpoint_property
     *
     * @return bool|null
     */
    public function getExcludeMountpointProperty()
    {
        return $this->container['exclude_mountpoint_property'];
    }

    /**
     * Sets exclude_mountpoint_property
     *
     * @param bool|null $exclude_mountpoint_property exclude_mountpoint_property
     *
     * @return self
     */
    public function setExcludeMountpointProperty($exclude_mountpoint_property)
    {

        if (is_null($exclude_mountpoint_property)) {
            throw new \InvalidArgumentException('non-nullable exclude_mountpoint_property cannot be null');
        }

        $this->container['exclude_mountpoint_property'] = $exclude_mountpoint_property;

        return $this;
    }

    /**
     * Gets only_from_scratch
     *
     * @return bool|null
     */
    public function getOnlyFromScratch()
    {
        return $this->container['only_from_scratch'];
    }

    /**
     * Sets only_from_scratch
     *
     * @param bool|null $only_from_scratch only_from_scratch
     *
     * @return self
     */
    public function setOnlyFromScratch($only_from_scratch)
    {

        if (is_null($only_from_scratch)) {
            throw new \InvalidArgumentException('non-nullable only_from_scratch cannot be null');
        }

        $this->container['only_from_scratch'] = $only_from_scratch;
