...
/**
 * CertificateCreate0 Class Doc Comment
 *
 * @category Class
 * @package  RMoore\Truenas
 * @author   OpenAPI Generator team
 ...
 */
class CertificateCreate0 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'certificate_create_0';
    ...
    protected static $openAPITypes = [
        'tos' => 'bool',
        'dns_mapping' => 'array<string,mixed>',
        'csr_id' => 'int',
        'signedby' => 'int',
        'key_length' => 'int',
        'renew_days' => 'int',
        ...
        'san' => 'string[]',
        'cert_extensions' => '\RMoore\Truenas\Model\CertExtensions'
    ];
    ...
    public const CREATE_TYPE_INTERNAL = 'CERTIFICATE_CREATE_INTERNAL';
    public const CREATE_TYPE_IMPORTED = 'CERTIFICATE_CREATE_IMPORTED';
    public const CREATE_TYPE_CSR = 'CERTIFICATE_CREATE_CSR';
    public const CREATE_TYPE_IMPORTED_CSR = 'CERTIFICATE_CREATE_IMPORTED_CSR';
    public const CREATE_TYPE_ACME = 'CERTIFICATE_CREATE_ACME';
    ...
    public function getCreateTypeAllowableValues()
    {
        return [
            ...
            self::CREATE_TYPE_CSR,
            self::CREATE_TYPE_IMPORTED_CSR,
            self::CREATE_TYPE_ACME,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('dns_mapping', $data ?? [], null);
    ...
    */
     ...
     */
    public function getDnsMapping()
    {
        return $this->container['dns_mapping'];
    }

    /**
     * Sets dns_mapping
     *
     * @param array<string,mixed>|null $dns_mapping dns_mapping
     *
     * @return self
     */
    public function setDnsMapping($dns_mapping)
    {

        if (is_null($dns_mapping)) {
            throw new \InvalidArgumentException('non-nullable dns_mapping cannot be null');
        }

        $this->container['dns_mapping'] = $dns_mapping;
     ...
     * Sets ec_curve
     *
     * @param string|null $ec_curve `key_type` attribute. If the `ec_curve` attribute is not specified for the Elliptic Curve Key, then default to using \"BrainpoolP384R1\" curve.
     *
     * @return self
     */
     ...
     * Sets key_type
     *
     * @param string|null $key_type `key_type` attribute. If the `ec_curve` attribute is not specified for the Elliptic Curve Key, then default to using \"BrainpoolP384R1\" curve.
     *
     * @return self
     */
     ...
     *
     * @return \RMoore\Truenas\Model\CertExtensions|null
     */
     ...
     *
     * @param \RMoore\Truenas\Model\CertExtensions|null $cert_extensions cert_extensions
     *
     * @return self
     */
